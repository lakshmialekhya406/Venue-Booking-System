...
<body>
    <div class="topnav">
        ...
        <a class="active" href="veuser.php">Users</a>
    ...
    <?php
        ...
        $q="select * from logindatabase";
        $result=mysqli_query($con,$q);
        $p=1;
        echo "<table align=center>";
        echo "<tr><th><font color='rgb(26, 2, 58)'>UId</th><th><font color='rgb(26, 2, 58)'>Username</th><th><font color='rgb(26, 2, 58)'>Email ID</th><th><font color='rgb(26, 2, 58)'>Mobile No</th></tr>";
        //echo "<tr><th><font color='white'>_______</th><th><font color='white'>_______________</th></tr>";
